...
int main (){
    ...
    */
    ...
    // printing the maximum y velocity
    printf("\nThe maximum y velocity is %d\n\n",y_velocity);
    // printing the maximum y we've got
    printf("\nThe maximum y we've got is %d\n\n",max_y);
...
// we found 45 for the max_y and 9 for the y_velocity for the test.txt file as expected in the example