...
# it's now 32 min instead of 24 min
# calculate the product of the first 3 blueprints, since others aren't available
# making the product of the first 3 blueprints, since the others aren't
...
bps = parse(lines)
answer=math.prod(search(bps[i], 32) for i in range(nb_wanted))

print("\nthe answer is :",answer,"\n")

# we found 56*62=3472 for test.txt as expected
