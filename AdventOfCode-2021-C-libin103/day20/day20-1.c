...
// we find that 35 pixels are on after 2 iterations for the test.txt file as expected in the puzzle
// we find that 91 pixels are on after 2 iterations for the test_bonus.txt file
// the program is working for the input20.txt file but it takes long time 